...
const u8 gText_PkmnElevatedToLvVar2[] = _("{STR_VAR_1} was elevated to Lv. {STR_VAR_2}.");
const u8 gText_PkmnLoweredToLvVar2[] = _("{STR_VAR_1} was lowered to Lv. {STR_VAR_2}.");
