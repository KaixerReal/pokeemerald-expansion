...
void ItemUseCB_RareCandy(u8 taskId, TaskFunc task)
{
    ...
    else
    {
        ...
        if (sFinalLevel > sInitialLevel)
        {
            ...
            if (holdEffectParam == 0 || holdEffectParam == 10 || holdEffectParam == 20) // Rare Candy and Candy Box and Infinite Candy and Common Candy
            {
...
void ItemUseCB_CommonCandy(u8 taskId, TaskFunc task)
{
    struct Pokemon *mon = &gPlayerParty[gPartyMenu.slotId];
    struct PartyMenuInternal *ptr = sPartyMenuInternal;
    s16 *arrayPtr = ptr->data;
...
u8 GetItemEffectType(u16 item)
{
    ...
    else if (itemEffect[3] & ITEM3_LEVEL_LOWER)
        return ITEM_EFFECT_LOWER_LEVEL;
