...
{
    MOVE_BIND, MOVE_WRAP, MOVE_FIRE_SPIN, 
    MOVE_CLAMP, MOVE_WHIRLPOOL, MOVE_SAND_TOMB, 
    MOVE_MAGMA_STORM, MOVE_INFESTATION, MOVE_SNAP_TRAP, 
    MOVE_THUNDER_CAGE, MOVE_MAELSTORM,
};
...
{//   Item                      1+  11+  21+  31+  41+  51+  61+  71+  81+  91+   Levels
    ...
    { ITEM_SUPER_REPEL,       {   _,   3,   3,   4,   4,   9,   8,   8,  30,   _, } },
...
static void Cmd_attackcanceler(void)
{
	...
	// Raging Boxer
    if (gSpecialStatuses[gBattlerAttacker].parentalBondState == PARENTAL_BOND_OFF
	&& GetBattlerAbility(gBattlerAttacker) == ABILITY_RAGING_BOXER
