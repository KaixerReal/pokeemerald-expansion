...
const struct Berry gBerries[] =
{
    ...
    [ITEM_LEPPA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 28,
        .maxYield = YIELD_RATE(40, 40, 40, 40),
        .minYield = YIELD_RATE(20, 20, 20, 20),
    ...
    [ITEM_ORAN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .size = 35,
        .maxYield = YIELD_RATE(60, 60, 60, 60),
        .minYield = YIELD_RATE(40, 40, 40, 40),
    ...
    [ITEM_SITRUS_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_YELLOW,
        .size = 95,
        .maxYield = YIELD_RATE(32, 32, 32, 32),
        .minYield = YIELD_RATE(16, 16, 16, 16),
