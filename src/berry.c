...
const struct Berry gBerries[] =
{
    [ITEM_CHERI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .size = 20,
        .maxYield = YIELD_RATE(54, 56, 76, 78),
        .minYield = YIELD_RATE(34, 36, 46, 48),
    ...
    [ITEM_ORAN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .size = 35,
        .maxYield = YIELD_RATE(66, 68, 76, 78),
        .minYield = YIELD_RATE(46, 48, 50, 52),
    ...
    [ITEM_SITRUS_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_YELLOW,
        .size = 95,
        .maxYield = YIELD_RATE(30, 32, 34, 36),
        .minYield = YIELD_RATE(16, 18, 20, 22),
