...
static void PrintMonAbilityName(void)
{   
    u16 ability = BanSomeAbilities(GetAbilityBySpecies(sMonSummaryScreen->summary.species, sMonSummaryScreen->summary.abilityNum), sMonSummaryScreen->summary.species);
