const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_MEGATRAINER_M] = TRAINER_PIC_MEGATRAINER_M,
    [FACILITY_CLASS_MEGATRAINER_F] = TRAINER_PIC_MEGATRAINER_F,
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_MEGATRAINER_M] = TRAINER_CLASS_MEGATRAINER,
    [FACILITY_CLASS_MEGATRAINER_F] = TRAINER_CLASS_MEGATRAINER,
};
