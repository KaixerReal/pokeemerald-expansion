...
static const struct TrainerMon sParty_GruntPetalburgWoods[] = {
    {
        ...
        .moves = {MOVE_VENOSHOCK, MOVE_HIDDEN_POWER, MOVE_SNARL},
        .nature = NATURE_TIMID,
        .friendship = 255,
        .heldItem = ITEM_ORAN_BERRY,
        .isShiny = FALSE,
...
static const struct TrainerMon sParty_James[] = {
    ...
    },
    {
        ...
        .lvl = 11,
        .ability = ABILITY_SPEED_BOOST,
        .moves = {MOVE_ACROBATICS, MOVE_SONIC_BOOM, MOVE_BUG_BITE},
        .nature = NATURE_JOLLY,
        .friendship = 255,
...
static const struct TrainerMon sParty_Roxanne[] = {
{
    ...
    .moves = {MOVE_VENOSHOCK, MOVE_ANCIENT_POWER, MOVE_HEX, MOVE_HIDDEN_POWER},
    .nature = NATURE_TIMID,
    .gender = TRAINER_MON_FEMALE,
    .friendship = 0,
    .heldItem = ITEM_FOCUS_SASH,
...
},
{
    ...
    .moves = {MOVE_BULLDOZE, MOVE_AERIAL_ACE, MOVE_ROCK_SLIDE, MOVE_VENOSHOCK},
    .nature = NATURE_NAIVE,
    .gender = TRAINER_MON_FEMALE,
    .friendship = 0,
    .heldItem = ITEM_BERRY_JUICE,
...
},
{
    ...
    .moves = {MOVE_HEX, MOVE_ANCIENT_POWER, MOVE_ICY_WIND, MOVE_HIDDEN_POWER},
    .nature = NATURE_TIMID,
    .gender = TRAINER_MON_FEMALE,
    .friendship = 0,
    .heldItem = ITEM_ORAN_BERRY,
...
},
{
    ...
    .lvl = 16,
    .ability = ABILITY_STORM_DRAIN,
    .moves = {MOVE_ANCIENT_POWER, MOVE_MEGA_DRAIN, MOVE_BRINE, MOVE_VENOSHOCK},
    .nature = NATURE_MODEST,
    .gender = TRAINER_MON_FEMALE,
    .friendship = 0,
    .heldItem = ITEM_LEFTOVERS,
