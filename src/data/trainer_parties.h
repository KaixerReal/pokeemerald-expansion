...
static const struct TrainerMon sParty_Wattson2[] = {
    {
        ...
        .moves = {MOVE_ZING_ZAP, MOVE_IRON_HEAD, MOVE_SPIKY_SHIELD},
        .nature = NATURE_JOLLY,
        .friendship = 255,
...
static const struct TrainerMon sParty_Tommy[] = { //Double Battle with Marc
    {
        ...
        .moves = {MOVE_HYPER_VOICE, MOVE_ANCIENT_POWER, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE},
        .nature = NATURE_MODEST,
        .friendship = 255,
        .heldItem = ITEM_FOCUS_SASH,
        .isShiny = FALSE,
...
static const struct TrainerMon sParty_Roxanne[] = {
{
    ...
    .lvl = 16,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_ROCK_TOMB, MOVE_BULLDOZE, MOVE_SELF_DESTRUCT, MOVE_SPIKES},
    .nature = NATURE_ADAMANT,
    .gender = TRAINER_MON_FEMALE,
    .friendship = 0,
...
},
{
    ...
    .moves = {MOVE_BULLDOZE, MOVE_AERIAL_ACE, MOVE_ROCK_TOMB, MOVE_VENOSHOCK},
    .nature = NATURE_NAIVE,
    .gender = TRAINER_MON_FEMALE,
    .friendship = 0,
    .heldItem = ITEM_BERRY_JUICE,
...
},
{
    ...
    .moves = {MOVE_PSYBEAM, MOVE_ANCIENT_POWER, MOVE_ICY_WIND, MOVE_HIDDEN_POWER},
    .nature = NATURE_TIMID,
    .gender = TRAINER_MON_FEMALE,
    .friendship = 0,
    .heldItem = ITEM_LUM_BERRY,
...
},
{
    ...
    .lvl = 16,
    .ability = ABILITY_STORM_DRAIN,
    .moves = {MOVE_ANCIENT_POWER, MOVE_MEGA_DRAIN, MOVE_BRINE, MOVE_RECOVER},
    .nature = NATURE_MODEST,
    .gender = TRAINER_MON_FEMALE,
    .friendship = 0,
    .heldItem = ITEM_BERRY_JUICE,
