...
const u32 gItemIcon_LvLCapCandy[] = INCBIN_U32("graphics/items/icons/lvlcap_candy.4bpp.lz");
const u32 gItemIconPalette_LvLCapCandy[] = INCBIN_U32("graphics/items/icon_palettes/lvlcap_candy.gbapal.lz");
