...
#define B_EXPLOSION_DEFENSE         GEN_1 // In Gen5+, Self-Destruct and Explosion don't halve the targets' defense.
...
#define B_SLEEP_TURNS               GEN_2 // In Gen5+, sleep lasts for 1-3 turns instead of 2-5 turns.
...
#define B_RESTORE_HELD_ITEMS        TRUE       // In Gen9 all non berry items are restored after battle.
...
// Eg: Replace with xxxx so you can use B_VAR_STARTING_STATUS for that feature.
#define B_VAR_STARTING_STATUS       VAR_USED_BATTLE_STUFF_1     // If this var has a value, assigning a STATUS_FIELD_xx_TERRAIN to it before battle causes the battle to start with that terrain active.
...
#define B_DISABLE_EVS                   TRUE    // If set to TRUE, shows a move's dynamic type in the summary screen and battle move box.
