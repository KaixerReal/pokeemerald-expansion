...
#define THREE_PERFECT_IV_COUNT LEGENDARY_MYTHICAL_ULTRABEAST_PARADOX_STARTER_FORMS_IV_COUNT
#define LEGENDARY_MYTHICAL_ULTRABEAST_PARADOX_STARTER_FORMS_IV_COUNT 3
