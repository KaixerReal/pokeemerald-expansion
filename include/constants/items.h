...
#define ITEM_BLASTOISINITE_Y (ITEM_POKESHI_DOLL + 3)
#define ITEM_KINGLERITE      (ITEM_POKESHI_DOLL + 4)
#define ITEM_GRIMMSNARLITE   (ITEM_POKESHI_DOLL + 5)
#define ITEM_CORVINITE       (ITEM_POKESHI_DOLL + 6)
#define ITEM_SNORLAXITE      (ITEM_POKESHI_DOLL + 7)
#define ITEM_BUTTERFRITE     (ITEM_POKESHI_DOLL + 8)
#define ITEM_DREDNAWITE      (ITEM_POKESHI_DOLL + 9)
#define ITEM_ALCREMITE       (ITEM_POKESHI_DOLL + 10)
#define ITEM_GENGARITE_Y     (ITEM_POKESHI_DOLL + 11)
#define ITEM_TOXTRICITE      (ITEM_POKESHI_DOLL + 12)
#define ITEM_COALOSSITE      (ITEM_POKESHI_DOLL + 13)
#define ITEM_SANDACONDITE    (ITEM_POKESHI_DOLL + 14)
#define ITEM_CENTICITE       (ITEM_POKESHI_DOLL + 15)
#define ITEM_HATTERENITE     (ITEM_POKESHI_DOLL + 16)
#define ITEM_COPPERAHJITE    (ITEM_POKESHI_DOLL + 17)
...
// CANDY BOX & INFINITE CANDY & COMMON_CANDY
