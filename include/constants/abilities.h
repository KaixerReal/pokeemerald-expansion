...
#define ABILITY_RAGING_BOXER     (ABILITIES_COUNT_GEN9 + 1)
#define ABILITY_HELLISH_SOUL     (ABILITIES_COUNT_GEN9 + 2)
#define ABILITY_GROUND_SHOCK     (ABILITIES_COUNT_GEN9 + 3)
#define ABILITY_SELF_SUFFICIENT  (ABILITIES_COUNT_GEN9 + 4)
#define ABILITY_RAMPAGE          (ABILITIES_COUNT_GEN9 + 5)
#define ABILITY_CUSTOM_6         (ABILITIES_COUNT_GEN9 + 6)
#define ABILITY_CUSTOM_7         (ABILITIES_COUNT_GEN9 + 7)
#define ABILITY_CUSTOM_8         (ABILITIES_COUNT_GEN9 + 8)
#define ABILITY_CUSTOM_9         (ABILITIES_COUNT_GEN9 + 9)
#define ABILITY_CUSTOM_10        (ABILITIES_COUNT_GEN9 + 10)
#define ABILITY_CUSTOM_11        (ABILITIES_COUNT_GEN9 + 11)
